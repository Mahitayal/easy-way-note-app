...
public class Download extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("DOWNLOAD STUDY MATERIAL");
        ...
        t1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "B.TECH", "BCA", " " }));

        t2.setFont(new java.awt.Font("Segoe UI", 3, 12)); // NOI18N
        t2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "1", "2", "3", "4", "5", "6", "7", "8", " " }));

        jLabel7.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel7.setText("YEAR :");

        t3.setFont(new java.awt.Font("Segoe UI", 3, 12)); // NOI18N
        t3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "1", "2", "3", "4" }));

        t4.setFont(new java.awt.Font("Segoe UI", 3, 12)); // NOI18N
        t4.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "CSE", "EE", "ME", " " }));

        t5.setFont(new java.awt.Font("Segoe UI", 3, 12)); // NOI18N
        t5.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "123", "456", "789" }));

        t6.setFont(new java.awt.Font("Segoe UI", 3, 12)); // NOI18N
        t6.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "SYLLABUS", "NOTES", "PREVIOUS YEAR QUESTIONS", " " }));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                            .addGap(165, 165, 165)
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                .addComponent(t1, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 364, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(t4, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 370, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            .addContainerGap()
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(link, javax.swing.GroupLayout.PREFERRED_SIZE, 206, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(39, 39, 39)
                                .addComponent(jButton3, javax.swing.GroupLayout.DEFAULT_SIZE, 124, Short.MAX_VALUE))
                            .addComponent(t6, 0, 369, Short.MAX_VALUE)
...
try{
        ...
        Statement st = c.createStatement();
         // Execute a query        
        ResultSet rs  = st.executeQuery("select * from  data where course  =  '"+t1.getSelectedItem().toString()+"' and sem = '"+t2.getSelectedItem().toString()+"'and year = '"+t3.getSelectedItem().toString()+"'and branch = '"+t4.getSelectedItem().toString()+"'and code = '"+t5.getSelectedItem().toString()+"'and type = '"+t6.getSelectedItem().toString()+"'");
...
java.awt.Toolkit.getDefaultToolkit().getSystemClipboard()
        .setContents(new java.awt.datatransfer.StringSelection(this.link.getText()), null);
